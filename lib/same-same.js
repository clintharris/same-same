...
exports.same = thingsAreEqual = function(thing1, thing2, cfg) {
    cfg = cfg || {};
 ...
 */
exports.arraysHaveSameContents = arraysHaveSameContents = function(objArr1, objArr2, cfg) {
    cfg = cfg || {};
    var log = cfg.logFcn || function(){};
    ...
    for(var i = 0; i < objArr1.length; i++) {
        if( !thingsAreEqual(objArr1[i], objArr2[i], cfg) ) {
...
exports.objectsAreEqual = objectsAreEqual = function(obj1, obj2, cfg) {
    cfg = cfg || {};
    var log = cfg.logFcn || function(){};
    ...
    for( var i = 0; i < obj1PropNamesArr.length; i++ ) {
        ...
        // Ensure the property values are the same
            ...
            var areEqual = thingsAreEqual( obj1[obj1PropertyName], obj2[obj2PropertyName], cfgClone );
